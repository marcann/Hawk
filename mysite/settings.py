...
SECRET_KEY = 'v(8*vrt+r+erx=7(%7n3r+v)u533cn*vy=*l5uce)&-8p931z)'
...
INSTALLED_APPS = [
    ...
    'game_calendar',
    'userauth',
    # DONE:30 Make userauth app.
    # DONE:80 Make calendar app.
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'mysite.context_processors.events.get_event_lists',
            ],
        },
    },
]
